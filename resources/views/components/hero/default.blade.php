<div class="flex justify-center items-center lg:min-h-[700px] py-32 relative w-full border-secondary">
    <div class="flex z-20 justify-center items-center text-light font-medium flex-col gap-y-[2rem]">
        ...
        <h1 class="ledger text-center lg:leading-[4rem] font-bold">Heritage Charm <br>& Modern Living</h1>
